<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:51:"/www/tpblog/public/../app/admin/view/admin/add.html";i:1526645922;s:42:"/www/tpblog/app/admin/view/common/top.html";i:1526645200;s:43:"/www/tpblog/app/admin/view/common/left.html";i:1526645200;s:45:"/www/tpblog/app/admin/view/common/footer.html";i:1526558785;}*/ ?>
<!DOCTYPE html>
<html>
                    ...
                    <div class="navbar">
                        <div class="navbar-inner">
                            <ul class="breadcrumb">
                                ...
                                <li><a href="<?php echo url('admin/index'); ?>">用户管理</a><span class="divider">/</span></li>
                            ...
                            <div class="form-horizontal">
                                <fieldset>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="id" type="text" value="<?php echo isset($user_info['id'])?$user_info['id']: ''; ?>"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="input-xlarge focused" id="username" type="text" value="<?php echo isset($user_info['username'])?$user_info['username']: ''; ?>"
                                                   placeholder="请输入用户名">
                                        </div>
                                    </div>
                                    <div class="control-group">
...
"
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input class="input-xlarge " id="email" type="text" placeholder="请输入邮箱" value="<?php echo isset($user_info['email'])?$user_info['email']: ''; ?>">
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <label>
                                                <input type="text" id="nick_name" value="" class="input-xlarge"
                                                       placeholder="请输入昵称" value="<?php echo isset($user_info['nick_name'])?$user_info['nick_name']: ''; ?>">
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group success">
                                        ...
                                        <div class="controls">
                                            <textarea name="desc" class="input-xlarge" id="desc" cols="30" rows="10"
                                                      placeholder="请输入个人描述"><?php echo isset($user_info['desc'])?$user_info['desc']:''; ?></textarea>
                                        </div>
                                    </div>
