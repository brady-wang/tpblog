<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:52:"/www/tpblog/public/../app/admin/view/cate/index.html";i:1526646770;s:42:"/www/tpblog/app/admin/view/common/top.html";i:1526646781;s:43:"/www/tpblog/app/admin/view/common/left.html";i:1526645200;s:45:"/www/tpblog/app/admin/view/common/footer.html";i:1526558785;}*/ ?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="span12">
                            <table class="table table-striped ">
                                ...
                                <tr >
                                    ...
                                    <td><a class="edit_cate" data-id="<?php echo $v['id']; ?>" href="javascript:void(0);">编辑</a>/<a class="cate_del" href = "javascript:void(0);" data-id="<?php echo $v['id']; ?>">删除</a></td>
                                </tr>
    ...
    $(function() {
            ...
            $("#submit_cate").click(function(){
                ...
                $.ajax({
                    type:'post',
                    dataType:'json',
                    url:"<?php echo url('cate/add'); ?>",
                    data:data,
                    success:function(res){
                        layer.msg(res.msg);
                        if(res.success == true){
                            var href = "<?php echo url('cate/index'); ?>";
        ...
        $(".cate_del").click(function(){
            ...
            layer.confirm('您确定要删除？', {
                ...
                var url = "<?php echo url('cate/del',['id'=>$v['id']]); ?>";
                var data = {};
                data.id = id;
