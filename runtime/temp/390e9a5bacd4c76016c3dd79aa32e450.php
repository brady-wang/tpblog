<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:53:"/www/tpblog/public/../app/admin/view/admin/index.html";i:1526645199;s:42:"/www/tpblog/app/admin/view/common/top.html";i:1526646781;s:43:"/www/tpblog/app/admin/view/common/left.html";i:1526645200;s:45:"/www/tpblog/app/admin/view/common/footer.html";i:1526558785;}*/ ?>
<!DOCTYPE html>
<html>
...
<div class="span3" id="sidebar">
    <ul class="nav nav-list bs-docs-sidenav nav-collapse ">
        ...
        <div class="span9" id="content">
            ...
            <div class="row-fluid">
                <a type="button" class="btn  pull-left " href="<?php echo url('admin/add'); ?>"><i class="icon-plus"></i>新增用户</a>
            </div>
                            ...
                            <table class="table table-striped">
                                ...
                                <?php foreach($list as $v): ?>
                                    <tr >
                                        ...
                                        <td><a href = "<?php echo url('admin/add',['id'=>$v['id']]); ?>">编辑</a>/<a class="admin_del_id" href = "javascript:void(0);" data-id="<?php echo $v['id']; ?>">删除</a></td>
                                    </tr>
                               <?php endforeach; ?>
    ...
    $(function() {
        $(".admin_del_id").click(function(){
            ...
            layer.confirm('您确定要删除？', {
                ...
                var url = "<?php echo url('admin/del',['id'=>$v['id']]); ?>";
                var data = {};
                data.id = id;
